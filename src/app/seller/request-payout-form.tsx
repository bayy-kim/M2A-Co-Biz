  ...
  return (
    <form action={action} className="space-y-lg">
      ...
      <div className="flex flex-col gap-xs">
        <label className="text-label-md text-on-surface" htmlFor="amountRupiah">Jumlah Penarikan</label>
        <input
      ...
      >
        ...
        {pending ? "Memproses..." : "Ajukan Pencairan"}
      </button>

      {state && "success" in state && state.success && (
        <div className="p-md bg-success/10 text-success rounded-lg text-label-sm">Pencairan diajukan. Menunggu persetujuan.</div>
      )}
